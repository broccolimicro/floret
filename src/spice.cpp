...
void spice_t::load(grammar_t &grammar)
{
	...
	n[5] = grammar.insert(new regular_expression("\\\"([^\\\"\\\\]|\\\\.)*\\\"", false));
	n[6] = grammar.insert(new regular_expression("[0-9]+", false));
	n[7] = grammar.insert(new regular_expression("false", false));
	n[8] = grammar.insert(new regular_expression("true", false));
	n[9] = grammar.insert(new stem(14, false));
	n[10] = grammar.insert(new regular_expression("[-+]", false));
	n[11] = grammar.insert(new regular_expression("e", false));
	n[12] = grammar.insert(new stem(14, false));
	n[13] = grammar.insert(new regular_expression("\\.", false));
	n[14] = grammar.insert(new stem(14, false));
	n[15] = grammar.insert(new stem(28, true));
	n[16] = grammar.insert(new stem(27, true));
	n[17] = grammar.insert(new stem(26, true));
	n[18] = grammar.insert(new regular_expression("[aAfFpPnNuUmMkKxXgG]", false));
	n[19] = grammar.insert(new stem(25, true));
	n[20] = grammar.insert(new stem(24, true));
	n[21] = grammar.insert(new regular_expression("[#_a-zA-Z][#_a-zA-Z0-9]*", false));
	n[22] = grammar.insert(new stem(9, true));
	n[23] = grammar.insert(new stem(17, true));
	n[24] = grammar.insert(new stem(9, true));
	n[25] = grammar.insert(new regular_expression(",", false));
	n[26] = grammar.insert(new stem(9, true));
	n[27] = grammar.insert(new stem(17, true));
	n[28] = grammar.insert(new stem(9, true));
	n[29] = grammar.insert(new regular_expression("=", false));
	n[30] = grammar.insert(new stem(9, true));
	n[31] = grammar.insert(new stem(10, true));
	n[32] = grammar.insert(new regular_expression("\\)", false));
	n[33] = grammar.insert(new stem(10, true));
	n[34] = grammar.insert(new stem(14, true));
	n[35] = grammar.insert(new regular_expression("\\(", false));
	n[36] = grammar.insert(new regular_expression("[vViI]", true));
	n[37] = grammar.insert(new stem(9, true));
	n[38] = grammar.insert(new stem(17, true));
	n[39] = grammar.insert(new stem(9, true));
	n[40] = grammar.insert(new regular_expression("=", false));
	n[41] = grammar.insert(new stem(9, true));
	n[42] = grammar.insert(new stem(23, true));
	n[43] = grammar.insert(new regular_expression("IC", true));
	n[44] = grammar.insert(new regular_expression("ic", true));
	n[45] = grammar.insert(new stem(1, true));
	n[46] = grammar.insert(new stem(21, true));
	n[47] = grammar.insert(new stem(9, true));
	n[48] = grammar.insert(new stem(22, true));
	n[49] = grammar.insert(new regular_expression("NODESET", true));
	n[50] = grammar.insert(new regular_expression("nodeset", true));
	n[51] = grammar.insert(new stem(1, true));
	n[52] = grammar.insert(new stem(21, true));
	n[53] = grammar.insert(new stem(9, true));
	n[54] = grammar.insert(new stem(20, true));
	n[55] = grammar.insert(new regular_expression("OPTIONS", true));
	n[56] = grammar.insert(new regular_expression("options", true));
	n[57] = grammar.insert(new stem(1, true));
	n[58] = grammar.insert(new stem(16, true));
	n[59] = grammar.insert(new stem(9, true));
	n[60] = grammar.insert(new stem(19, true));
	n[61] = grammar.insert(new regular_expression("MODEL", true));
	n[62] = grammar.insert(new regular_expression("model", true));
	n[63] = grammar.insert(new stem(1, true));
	n[64] = grammar.insert(new stem(16, true));
	n[65] = grammar.insert(new stem(9, true));
	n[66] = grammar.insert(new stem(10, true));
	n[67] = grammar.insert(new stem(9, true));
	n[68] = grammar.insert(new stem(10, true));
	n[69] = grammar.insert(new stem(9, true));
	n[70] = grammar.insert(new stem(18, true));
	n[71] = grammar.insert(new stem(9, true));
	n[72] = grammar.insert(new stem(10, true));
	n[73] = grammar.insert(new stem(9, true));
	n[74] = grammar.insert(new stem(17, true));
	n[75] = grammar.insert(new stem(16, true));
	n[76] = grammar.insert(new stem(1, true));
	n[77] = grammar.insert(new stem(15, true));
	n[78] = grammar.insert(new stem(9, true));
	n[79] = grammar.insert(new stem(10, true));
	n[80] = grammar.insert(new stem(14, true));
	n[81] = grammar.insert(new regular_expression("[rRcClLdDqQjJmMxXfFhHeEgGkKvViI]", true));
	n[82] = grammar.insert(new stem(9, true));
	n[83] = grammar.insert(new stem(10, true));
	n[84] = grammar.insert(new regular_expression("ENDS", true));
	n[85] = grammar.insert(new regular_expression("ends", true));
	n[86] = grammar.insert(new regular_expression("\\.", true));
	n[87] = grammar.insert(new regular_expression("SUBCKT", true));
	n[88] = grammar.insert(new regular_expression("subckt", true));
	n[89] = grammar.insert(new stem(1, true));
	n[90] = grammar.insert(new stem(13, true));
	n[91] = grammar.insert(new stem(1, true));
	n[92] = grammar.insert(new stem(12, true));
	n[93] = grammar.insert(new stem(1, true));
	n[94] = grammar.insert(new stem(11, true));
	n[95] = grammar.insert(new stem(9, true));
	n[96] = grammar.insert(new stem(10, true));
	n[97] = grammar.insert(new stem(9, true));
	n[98] = grammar.insert(new stem(8, true));
	n[99] = grammar.insert(new regular_expression("END", true));
	n[100] = grammar.insert(new regular_expression("end", true));
	n[101] = grammar.insert(new regular_expression("\\.", true));
	n[102] = grammar.insert(new regular_expression("[\\0]", true));
	n[103] = grammar.insert(new stem(1, true));
	n[104] = grammar.insert(new stem(7, true));
	n[105] = grammar.insert(new stem(6, true));
	n[106] = grammar.insert(new stem(5, true));
	n[107] = grammar.insert(new stem(4, true));
	n[108] = grammar.insert(new stem(3, true));
	n[109] = grammar.insert(new stem(2, true));
	...
	n[71]->next.push_back(n[75]);
	n[71]->next.push_back(n[74]);
	n[71]->next.push_back(n[72]);
	n[71]->next.push_back(NULL);
	n[72]->next.push_back(n[71]);
	n[73]->next.push_back(n[75]);
	n[73]->next.push_back(n[74]);
	n[73]->next.push_back(n[72]);
	n[73]->next.push_back(NULL);
	n[74]->next.push_back(n[73]);
	n[75]->next.push_back(n[75]);
	n[75]->next.push_back(n[74]);
	n[75]->next.push_back(n[72]);
	...
	n[91]->next.push_back(n[92]);
	n[91]->next.push_back(n[91]);
	n[91]->next.push_back(n[90]);
	n[92]->next.push_back(n[92]);
	n[92]->next.push_back(n[91]);
	n[92]->next.push_back(n[90]);
	n[93]->next.push_back(n[92]);
	n[93]->next.push_back(n[91]);
	n[93]->next.push_back(n[90]);
	...
	n[108]->next.push_back(n[104]);
	n[108]->next.push_back(n[102]);
	n[109]->next.push_back(n[111]);
	n[109]->next.push_back(n[110]);
	n[109]->next.push_back(n[104]);
	n[109]->next.push_back(n[102]);
	...
	n[111]->next.push_back(n[104]);
	n[111]->next.push_back(n[102]);

	grammar.rules[0].start.push_back(n[111]);
	grammar.rules[0].start.push_back(n[110]);
	grammar.rules[0].start.push_back(n[104]);
	grammar.rules[1].start.push_back(n[3]);
	grammar.rules[2].start.push_back(n[98]);
	grammar.rules[3].start.push_back(n[70]);
	grammar.rules[4].start.push_back(n[60]);
	grammar.rules[5].start.push_back(n[54]);
	grammar.rules[6].start.push_back(n[48]);
	grammar.rules[7].start.push_back(n[101]);
	grammar.rules[8].start.push_back(n[88]);
	grammar.rules[8].start.push_back(n[87]);
	grammar.rules[9].start.push_back(n[4]);
	grammar.rules[10].start.push_back(n[21]);
	grammar.rules[11].start.push_back(n[83]);
	grammar.rules[11].start.push_back(NULL);
	grammar.rules[12].start.push_back(n[81]);
	grammar.rules[13].start.push_back(n[86]);
	grammar.rules[14].start.push_back(n[6]);
	grammar.rules[15].start.push_back(n[75]);
	grammar.rules[15].start.push_back(n[74]);
	grammar.rules[15].start.push_back(n[72]);
	grammar.rules[15].start.push_back(NULL);
	grammar.rules[16].start.push_back(n[31]);
	grammar.rules[17].start.push_back(n[20]);
	grammar.rules[18].start.push_back(n[62]);
	grammar.rules[18].start.push_back(n[61]);
	grammar.rules[19].start.push_back(n[56]);
	grammar.rules[19].start.push_back(n[55]);
	grammar.rules[20].start.push_back(n[50]);
	grammar.rules[20].start.push_back(n[49]);
	grammar.rules[21].start.push_back(n[42]);
	grammar.rules[22].start.push_back(n[44]);
	grammar.rules[22].start.push_back(n[43]);
	grammar.rules[23].start.push_back(n[36]);
	grammar.rules[24].start.push_back(n[17]);
	grammar.rules[24].start.push_back(n[16]);
	grammar.rules[24].start.push_back(n[15]);
	grammar.rules[25].start.push_back(n[18]);
	grammar.rules[26].start.push_back(n[8]);
	grammar.rules[26].start.push_back(n[7]);
	grammar.rules[27].start.push_back(n[5]);
	grammar.rules[28].start.push_back(n[14]);
}
